      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('cs/home') }}" class="nav-link {{ (request()->is('home')) ? 'active' : '' }}">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('cs/paymentatin') }}" class="nav-link {{ (Request::segment(2) === 'paymentatin') ? 'active' : '' }}">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('cs/cslog') }}" class="nav-link {{ (Request::segment(2) === 'cslog') ? 'active' : '' }}">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('cs/import') }}" class="nav-link {{ (Request::segment(2) === 'import') ? 'active' : '' }}">
